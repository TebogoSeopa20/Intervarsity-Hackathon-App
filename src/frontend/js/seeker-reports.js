// seeker-reports.js
// Product Reporting and Management System
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadUserReports() {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/users/${user.id}/seeker-reports?status=${status}`);
                ...
                <div class="report-item" data-report-id="${report.report_id}">
                    <div class="report-header">
                        <div>
                            ...
                            <div class="report-shop">${report.shop_name}</div>
                        </div>
    ...
    async function handleReportSubmit(e) {
        ...
        // Basic validation
        if (!formData.get('productName') || !formData.get('shopName') || 
        ...
        try {
            ...
            const reportData = {
                ...
                shop_address: formData.get('shopAddress') || null,
            ...
            // Submit report
            const response = await fetch(`${API_BASE_URL}/api/seeker-reports`, {
                method: 'POST',
                headers: {
    ...
    function openBarcodeScanner() {
        ...
        window.location.href = 'foodId.html?mode=barcode&returnTo=reports';
    }

    async function viewReport(reportId) {
        try {
            const response = await fetch(`${API_BASE_URL}/api/seeker-reports/${reportId}`);
    ...
    function displayReportDetail(report) {
        ...
        reportDetailContent.innerHTML = `
            ...
            <div class="report-detail-item">
                <div class="report-detail-label">Shop</div>
                <div class="report-detail-value">${report.shop_name} ${report.shop_address ? `<br>${report.shop_address}` : ''}</div>
            </div>
    ...
    async function confirmDeleteReport() {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/seeker-reports/${reportToDelete}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
